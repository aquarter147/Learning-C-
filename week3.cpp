...
class circle : public Shape{
    public: 
		...
		// circle(float _x, float _y, float _R, float _thickness, string _color){
		// 		this->R = _R;
		// 		this->x = _x;
		// 		this->y = _y;
		// 		this ->color = _color;
...
class rectangle: public Shape{
    public:
		...
		// rectangle(float _x, float _y, float _a, float _b, float _thickness, string _color){
		// 		this->a = _a;
		// 		this->b = _b;
		// 		this->x = _x;
		// 		this->y = _y;
...
class triangle: public Shape{
    public:
		...
		// triangle(float _x, float _y, float _a, float _b,float _c, float _thickness, string _color){
		// 		this->a = _a;
		// 		this->b = _b;
		// 		this->c = _c;
		// 		this->x = _x;
...
class square: public Shape{
    public:
		...
		// square(float _x, float _y, float _a, float _thickness, string _color){
		// 		this->a = _a;
		// 		this->x = _x;
		// 		this->y = _y;
		// 		this ->color = _color;
...
class oval: public Shape{
    public:
		...
		// oval(float _x, float _y, float _a, float _b, float _thickness, string _color){
		// 		this->a = _a;
		// 		this->b = _b;
		// 		this->x = _x;
		// 		this->y = _y;
...
class line: public Shape{
    public:
		...
		// line(float _x, float _y, float _a, float _thickness, string _color){
		// 		this->a = _a;
		// 		this->x = _x;
		// 		this->y = _y;
		// 		this ->color = _color;
...
class Edge : public Shape{
	...
	public:
		...
		void Get2(){ // Hàm in thông tin của cạnh được tạo mặc định từ 1 Shape
			cout << "\nCanh noi tam cua hinh thu: " << S1->index << " va " << S2->index;
		...
		// Edge(Shape a, Shape b, string _color, float _thickness){
		// 	S1 = new Shape();
		// 	S1->x = a.x;
		// 	S1->y = a.y;
		// 	S2 = new Shape();
...
// void Print_F(Factory:: ShapeType shape_type){
// 	Shape *shape = Factory::createShape(shape_type);
// 	shape->Get();
// }
...
void AddEdge(vector <Edge*>& E, vector <Shape*>& DS){
	...
	cin >> E.back()->src;
	while (E.back()->src<=0 || E.back()->src >DS.size()){
		cout << "Danh sach khong co hinh nay!";
	...
	cin >> E.back()->des;
	while (E.back()->des<=0 || E.back()->des>DS.size()){
		cout << "Danh sach khong co hinh nay!";
		cout << "\nMoi ban nhap lai hinh thu nhat: ";
		cin >>E.back()->des;
	}
...
//Hàm in ra tất cả các cạnh xuất phát từ 1 shape (có thể có)
void Print_Shape(vector <Edge*>& E_1, vector <Shape*>& DS){
	...
	int a;
	cout << "Nhap STT hinh ban muon tao tat ca cac canh noi tam: ";
	cin >>a;
	while(a<=0||a>DS.size()){
...
void Read_E(vector<Edge*> &EE){
	for(int i=0;i<EE.size();i++){
		cout << "Canh thu " << i+1 <<endl;
		cout << "canh noi 2 hinh " << EE[i]->src << " va " << EE[i]->des; 
		cout << "\nMau sac: " << EE[i]->color;
		cout << "\nDo day net: " << EE[i]->thickness;
}
//////////////////////////////////////////////////////////////////////////////////////////

// Đọc file
void Read_data (vector<Shape*> & SS, vector <Edge*> & EE){
	std::ifstream fileInput("C:/Users/admin/Documents/t.a/nhat.txt");
